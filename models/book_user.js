const books_users = [
  {bookId: "0", userEmail: "wwang24@outlook.com", status: "finished"},
  {bookId: "1", userEmail: "wwang24@outlook.com", status: "reading"},
  {bookId: "2", userEmail: "wwang24@outlook.com", status: "todo"},
  {bookId: "3", userEmail: "wwang24@outlook.com", status: "todo"}
];
...
exports.upsert = (book_user) => {
  let idx = books_users.findIndex((bu) => {
    return bu.bookId == book_user.bookId && bu.userEmail == book_user.userEmail;
  });
  if (idx == -1) {
    exports.add(book_user);
  } else {
